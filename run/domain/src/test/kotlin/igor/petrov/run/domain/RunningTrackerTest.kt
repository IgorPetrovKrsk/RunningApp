...
import igor.petrov.test.LocationObserverFake
import igor.petrov.test.MainCoroutineExtension
import igor.petrov.test.PhoneToWatchConnectorFake
...
class RunningTrackerTest{
    ...
    fun testCombiningRunData() = runTest{
        runningTracker.runData.test {
            ...
            watchConnectorFake.sendFromWatchToPhone(MessagingAction.HeartRateUpdate(150))
            ...
            assertThat(emission3.heartRates).isEqualTo(listOf(150))
            assertThat(emission4.heartRates).isEqualTo(listOf(150,170))
