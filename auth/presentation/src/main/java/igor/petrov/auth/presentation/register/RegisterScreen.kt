...
import igor.petrov.core.presentation.designsystem.CheckIcon
import igor.petrov.core.presentation.designsystem.CrossIcon
...
private fun RegisterScreen(
    ...
    GradientBackground {
        Column(modifier = Modifier
            ...
            RunningAppTextField(state = state.email,
                startIcon = EmailIcon,
            ...
            RunningAppPasswordTextField(state = state.password,
            ...
            Spacer(modifier = Modifier.height(4.dp))
            PasswordRequirement(
                text = stringResource(id = R.string.contains_lower_case_character, UserDataValidator.MIN_PASSWORD_LENGTH),
                isValid = state.passwordValidationState.hasLowerCaseCharacter)
            Spacer(modifier = Modifier.height(4.dp))
            PasswordRequirement(
                text = stringResource(id = R.string.contains_upper_case_character, UserDataValidator.MIN_PASSWORD_LENGTH),
                isValid = state.passwordValidationState.hasUpperCaseCharacter)
            Spacer(modifier = Modifier.height(32.dp))
            RunningAppActionButton(text = stringResource(id = R.string.register),
...
fun PasswordRequirement(
    ...
    Row(modifier = modifier,
        ...
        Icon(imageVector = if (isValid) CrossIcon else CheckIcon, contentDescription = null,
...
private fun RegisterScreenRootScreenPreview() {
    RunningAppTheme {
        RegisterScreen(
            state = RegisterState(passwordValidationState = PasswordValidationState(hasNumber = true, hasLowerCaseCharacter = true, hasUpperCaseCharacter = true, hasMinLength = true)),
            onAction = {}
        )
    }
}