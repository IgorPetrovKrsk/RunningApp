...
fun Modifier.ambientMode(
    ...
    val translationX by rememberBurnInTranslation(isAmbientMode = isAmbientMode, burnInProtectionRequired = burnInProtectionRequired)
    val translationY by rememberBurnInTranslation(isAmbientMode = isAmbientMode, burnInProtectionRequired = burnInProtectionRequired)
